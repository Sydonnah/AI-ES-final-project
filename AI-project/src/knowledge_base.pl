...
save_patient(Name,Age,Gender,Temperature,Dizzy,Faint,Blur,SysR,DiaR,Fever,Fatigue,Head,Sore,Diffb,Chest,Losm,Cough,Lot,Run,Muscle,Sneeze,Boc,Cancer,Dia,Lung,Kid,Stroke,Liver,Sick,Heart,Alz,Cys):-
   ...
   Riskfactor>24,Riskfactor=<58 ->Deltacount is 1, Omnicroncount is 0,Mildcount is 0, Severecount is 1, send(Lbl24,append,'Patient may have the Delta Covid-19 variant, Patient should visit the doctor immediately');
    ...
    Riskfactor>58,Riskfactor=<108,Underlyingfactor =< 1->Deltacount is 0, Omnicroncount is 1, Mildcount is 0, Severecount is 1, Underlyingcount is 1; Underlyingcount is 0, send(Lbl24,append,'Patient may have the Ominicron Covid-19 variant, Patient should visit the doctor immediately')),


    updatestats(Deltacount,Omnicroncount,Mildcount,Severecount,Underlyingcount),
...
stats_display:-
    stats(Deltacount,Omnicroncount,Mildcount,Severecount,Underlyingcount,Totalcount),
    ...
    send(CS,append,new(Lbl26,label)),send(Lbl26,append,OUnderlyingstat),
    send(CS,open)
    .
